...
public class Spring {
    ...
    public static void main(String[] args) throws Exception {
        ...
        runJava8("5.0.11.RELEASE", "0.7.12.RELEASE", "spring-4.x", "spring-5.0.x");
        runJava8("5.0.12.RELEASE", "0.7.14.RELEASE", "spring-4.x", "spring-5.0.x");
        ...
        runJava8("5.1.3.RELEASE", "0.8.3.RELEASE", "spring-4.x", "spring-5.1.x");
        runJava8("5.1.4.RELEASE", "0.8.4.RELEASE", "spring-4.x", "spring-5.1.x");
    }
