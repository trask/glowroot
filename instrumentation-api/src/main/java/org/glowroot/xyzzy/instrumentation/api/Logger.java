...
/**
 * Very thin wrapper around SLF4J so instrumentation doesn't have to worry about SLF4J shading.
 */
public abstract class Logger {
    ...
    static {
        try {
            loggerFactory =
                    (LoggerFactory) Class.forName("org.glowroot.xyzzy.engine.logging.LoggerFactoryImpl")
