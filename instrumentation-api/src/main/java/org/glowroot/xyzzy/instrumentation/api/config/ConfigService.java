 ...
 */
package org.glowroot.xyzzy.instrumentation.api.config;
...
public interface ConfigService {
     ...
     * META-INF/xyzzy.instrumentation.json file, and can be modified (assuming they are not
     * marked as hidden) on the configuration page under the instrumentation's configuration
     * section.
     */
