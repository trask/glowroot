 ...
 */
package org.glowroot.xyzzy.instrumentation.log4j1x;
...
public class Log4j1xInstrumentation {
    ...
    public static class ForcedLogAdvice {
        ...
        public static TraceEntry onBefore(ThreadContext context, @BindReceiver Logger logger,
            ...
            if (LoggerInstrumentationProperties.markTraceAsError(lvl >= ERROR_INT, lvl >= WARN_INT, t != null)) {
    ...
    private static class LogMessageSupplier extends MessageSupplier {
        ...
        public Message get() {
            return Message.create("log {}: {} - {}", getLevelStr(level),
                    LoggerInstrumentationProperties.getAbbreviatedLoggerName(loggerName), messageText);
        }
