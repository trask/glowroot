...
//see nearly identical copy of this in ApacheHttpClientInstrumentation
public class WiremockApacheHttpClientInstrumentation {
    ...
    public static class ExecuteAdvice {
        ...
        public static @Nullable TraceEntry onBefore(ThreadContext context,
            ...
            return context.startServiceCallEntry("HTTP", method + stripQueryString(uri),
