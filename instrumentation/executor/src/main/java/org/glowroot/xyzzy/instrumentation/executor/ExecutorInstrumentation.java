...
public class ExecutorInstrumentation {
    ...
    @Pointcut(className = "org.glowroot.xyzzy.instrumentation.executor.RunnableWrapper",
    ...
    @Pointcut(className = "org.glowroot.xyzzy.instrumentation.executor.CallableWrapper",
