    ...
    public static class ServiceAdvice {
        ...
        private static @Nullable TraceEntry onBeforeCommon(OptionalThreadContext context,
            ...
            AuxThreadContext auxContextObj = (AuxThreadContext) request
                    .getAttribute(AsyncServletInstrumentation.GLOWROOT_AUX_CONTEXT_REQUEST_ATTRIBUTE);
            if (auxContextObj != null) {
                request.removeAttribute(AsyncServletInstrumentation.GLOWROOT_AUX_CONTEXT_REQUEST_ATTRIBUTE);
            ...
            if (ServletInstrumentationProperties.captureSessionAttributeNamesContainsId()) {
                ...
                if (messageSupplier != null) {
                    messageSupplier.putSessionAttributeChangedValue(
                            ServletInstrumentationProperties.HTTP_SESSION_ID_ATTR, session.getId());
                }
            }
        }
    }
