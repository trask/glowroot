 ...
 */
package org.glowroot.xyzzy.instrumentation.servlet.bootsafe;
...
import org.glowroot.xyzzy.instrumentation.api.util.ImmutableSet;
...
public class ServletInstrumentationProperties {
    ...
    public static class SessionAttributePath {
        ...
        public boolean isSessionId() {
            return attributeName.equals(ServletInstrumentationProperties.HTTP_SESSION_ID_ATTR)
