...
public class ConnectionAndTxLifecycleIT {
    ...
    public void testConnectionLifecycleGetConnectionThrows() throws Exception {
        ...
        // when
        IncomingSpan incomingSpan = container.execute(ExecuteGetConnectionOnThrowingDataSource.class);
    ...
    public void testConnectionLifecycleCloseConnectionThrows() throws Exception {
        ...
        // when
        IncomingSpan incomingSpan = container.execute(ExecuteCloseConnectionOnThrowingDataSource.class);
    ...
    public void testConnectionLifecycleCloseConnectionThrowsDisabled() throws Exception {
        ...
        assertSingleLocalSpanMessage(incomingSpan).startsWith("Resource leak");
    }
    ...
    public void testTransactionLifecycle() throws Exception {
        ...
        // when
        IncomingSpan incomingSpan = container.execute(ExecuteSetAutoCommit.class);
