...
import org.glowroot.xyzzy.instrumentation.jdbc.PreparedStatementMirror.ByteArrayParameterValue;
import org.glowroot.xyzzy.instrumentation.jdbc.PreparedStatementMirror.StreamingParameterValue;
import org.glowroot.xyzzy.instrumentation.jdbc.message.BatchPreparedStatementMessageSupplier;
import org.glowroot.xyzzy.instrumentation.jdbc.message.BatchPreparedStatementMessageSupplier2;
import org.glowroot.xyzzy.instrumentation.jdbc.message.PreparedStatementMessageSupplier;
...
public class StatementInstrumentation {
    ...
    public static class SetBytesAdvice {
        ...
        private static void setBytes(PreparedStatementMirror mirror, int parameterIndex, byte[] x) {
            boolean displayAsHex = JdbcInstrumentationProperties.displayBinaryParameterAsHex(mirror.getSql(),
                    parameterIndex);
    ...
    public static class PreparedStatementExecuteAdvice {
        ...
        public static void onReturn(@BindTraveler QueryEntry queryEntry) {
            queryEntry.endWithLocationStackTrace(JdbcInstrumentationProperties.stackTraceThresholdMillis(),
                    MILLISECONDS);
        }
        @OnThrow
        public static void onThrow(@BindThrowable Throwable t,
