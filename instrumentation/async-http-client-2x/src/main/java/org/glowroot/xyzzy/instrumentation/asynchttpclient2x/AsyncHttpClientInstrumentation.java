 ...
 */
package org.glowroot.xyzzy.instrumentation.asynchttpclient2x;
...
import org.glowroot.xyzzy.instrumentation.asynchttpclient2x.bootsafe.DirectExecutor;
...
public class AsyncHttpClientInstrumentation {
    ...
    public static class ExecuteRequestAdvice {
        ...
        public static @Nullable AsyncTraceEntry onBefore(ThreadContext context,
            ...
            return context.startAsyncServiceCallEntry("HTTP", method + stripQueryString(url),
