...
public class Log4jInstrumentation {
    ...
    public static class CallAppendersAdvice {
        ...
        public static LogAdviceTraveler onBefore(ThreadContext context, @BindReceiver Logger logger,
            ...
            // not using LoggerInstrumentationProperties.getAbbreviatedLoggerName() because log4j2
            // 2.9.0+ uses canonical class name instead of class name for the logger name (see
            // https://issues.apache.org/jira/browse/LOG4J2-2023) and this causes
            // LoggerInstrumentationProperties.getAbbreviatedLoggerName() to abbreviate outer class
            // names, e.g. a logger for org.example.Outer$Inner has logger name
            // org.example.Outer.Inner and would then be abbreviated as org.example.O.Inner, which
            // seems not ideal
