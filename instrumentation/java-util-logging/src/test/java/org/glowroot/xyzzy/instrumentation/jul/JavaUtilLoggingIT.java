...
public class JavaUtilLoggingIT {
    ...
    public void testLog() throws Exception {
        ...
        assertThat(localSpan.getMessage())
                .isEqualTo("log info: o.g.x.i.j.JavaUtilLoggingIT$ShouldLog - cde");
        assertThat(localSpan.childSpans()).isEmpty();

        localSpan = (LocalSpan) i.next();
        assertThat(localSpan.getMessage())
                .isEqualTo("log warning: o.g.x.i.j.JavaUtilLoggingIT$ShouldLog - def");
        assertThat(localSpan.childSpans()).isEmpty();

        localSpan = (LocalSpan) i.next();
        assertThat(localSpan.getMessage())
                .isEqualTo("log severe: o.g.x.i.j.JavaUtilLoggingIT$ShouldLog - efg");
        assertThat(localSpan.childSpans()).isEmpty();
    ...
    public void testLogWithThrowable() throws Exception {
        ...
        LocalSpan localSpan = (LocalSpan) i.next();
        assertThat(localSpan.getMessage())
                .isEqualTo("log info: o.g.x.i.j.JavaUtilLoggingIT$ShouldLogWithThrowable - cde_");
        ...
        assertThat(localSpan.getError().exception().getMessage()).isEqualTo("345");
        ...
        assertThat(localSpan.getMessage()).isEqualTo(
                "log warning: o.g.x.i.j.JavaUtilLoggingIT$ShouldLogWithThrowable - def_");
        assertThat(localSpan.getError().message()).isNull();
        assertThat(localSpan.getError().exception()).isInstanceOf(IllegalStateException.class);
        ...
        localSpan = (LocalSpan) i.next();
        assertThat(localSpan.getMessage())
                .isEqualTo("log severe: o.g.x.i.j.JavaUtilLoggingIT$ShouldLogWithThrowable - efg_");
        assertThat(localSpan.getError().message()).isNull();
        assertThat(localSpan.getError().exception()).isInstanceOf(IllegalStateException.class);
    ...
    public void testLogWithNullThrowable() throws Exception {
        ...
        LocalSpan localSpan = (LocalSpan) i.next();
        assertThat(localSpan.getMessage()).isEqualTo(
                "log info: o.g.x.i.j.JavaUtilLoggingIT$ShouldLogWithNullThrowable - cde_");
        assertThat(localSpan.getError()).isNull(); // populated only if level > WARNING
        assertThat(localSpan.childSpans()).isEmpty();

        localSpan = (LocalSpan) i.next();
        assertThat(localSpan.getMessage()).isEqualTo(
                "log warning: o.g.x.i.j.JavaUtilLoggingIT$ShouldLogWithNullThrowable - def_");
        assertThat(localSpan.getError().message()).isEqualTo("def_");
        assertThat(localSpan.childSpans()).isEmpty();

        localSpan = (LocalSpan) i.next();
        assertThat(localSpan.getMessage()).isEqualTo(
                "log severe: o.g.x.i.j.JavaUtilLoggingIT$ShouldLogWithNullThrowable - efg_");
    ...
    public void testLogWithLogRecord() throws Exception {
        ...
        localSpan = (LocalSpan) i.next();
        assertThat(localSpan.getMessage()).isEqualTo(
                "log warning: o.g.x.i.j.JavaUtilLoggingIT$ShouldLogWithLogRecord - def__");
        assertThat(localSpan.childSpans()).isEmpty();
    ...
    public void testLogWithPriority() throws Exception {
        ...
        LocalSpan localSpan = (LocalSpan) i.next();
        assertThat(localSpan.getMessage())
                .isEqualTo("log info: o.g.x.i.j.JavaUtilLoggingIT$ShouldLogWithPriority - cde__");
        assertThat(localSpan.childSpans()).isEmpty();

        localSpan = (LocalSpan) i.next();
        assertThat(localSpan.getMessage()).isEqualTo(
                "log warning: o.g.x.i.j.JavaUtilLoggingIT$ShouldLogWithPriority - def__");
        assertThat(localSpan.childSpans()).isEmpty();

        localSpan = (LocalSpan) i.next();
        assertThat(localSpan.getMessage())
                .isEqualTo("log severe: o.g.x.i.j.JavaUtilLoggingIT$ShouldLogWithPriority - efg__");
        assertThat(localSpan.childSpans()).isEmpty();
    ...
    public void testLogWithPriorityAndThrowable() throws Exception {
        ...
        // then
        assertThat(incomingSpan.getError().message()).isEqualTo("efg___");
        assertThat(incomingSpan.getError().exception()).isInstanceOf(IllegalStateException.class);
        ...
        LocalSpan localSpan = (LocalSpan) i.next();
        assertThat(localSpan.getMessage()).isEqualTo(
                "log info: o.g.x.i.j.JavaUtilLoggingIT$ShouldLogWithPriorityAndThrowable - cde___");
        assertThat(localSpan.getError().message()).isNull();
        assertThat(localSpan.getError().exception()).isInstanceOf(IllegalStateException.class);
        assertThat(localSpan.getError().exception().getMessage()).isEqualTo("345_");
        assertThat(localSpan.getError().exception().getStackTrace()[0].getMethodName())
                .isEqualTo("transactionMarker");
        assertThat(localSpan.childSpans()).isEmpty();
        ...
        localSpan = (LocalSpan) i.next();
        assertThat(localSpan.getMessage()).isEqualTo(
                "log warning: o.g.x.i.j.JavaUtilLoggingIT$ShouldLogWithPriorityAndThrowable - def___");
        assertThat(localSpan.getError().message()).isNull();
        assertThat(localSpan.getError().exception()).isInstanceOf(IllegalStateException.class);
        ...
        localSpan = (LocalSpan) i.next();
        assertThat(localSpan.getMessage()).isEqualTo(
                "log severe: o.g.x.i.j.JavaUtilLoggingIT$ShouldLogWithPriorityAndThrowable - efg___");
        assertThat(localSpan.getError().message()).isNull();
        assertThat(localSpan.getError().exception()).isInstanceOf(IllegalStateException.class);
    ...
    public void testLogWithPriorityAndNullThrowable() throws Exception {
        ...
        LocalSpan localSpan = (LocalSpan) i.next();
        assertThat(localSpan.getMessage()).isEqualTo("log info: o.g.x.i.j.JavaUtilLoggingIT"
                + "$ShouldLogWithPriorityAndNullThrowable - cde___null");
        assertThat(localSpan.getError()).isNull(); // populated only if level > WARNING
        assertThat(localSpan.childSpans()).isEmpty();

        localSpan = (LocalSpan) i.next();
        assertThat(localSpan.getMessage()).isEqualTo("log warning: o.g.x.i.j.JavaUtilLoggingIT"
                + "$ShouldLogWithPriorityAndNullThrowable - def___null");
        assertThat(localSpan.getError().message()).isEqualTo("def___null");
        assertThat(localSpan.childSpans()).isEmpty();

        localSpan = (LocalSpan) i.next();
        assertThat(localSpan.getMessage()).isEqualTo("log severe: o.g.x.i.j.JavaUtilLoggingIT"
    ...
    public void testLogWithParameters() throws Exception {
        ...
        LocalSpan localSpan = (LocalSpan) i.next();
        assertThat(localSpan.getMessage()).isEqualTo(
                "log info: o.g.x.i.j.JavaUtilLoggingIT$ShouldLogWithParameters - efg_56_67");
        assertThat(localSpan.childSpans()).isEmpty();

        localSpan = (LocalSpan) i.next();
        assertThat(localSpan.getMessage()).isEqualTo(
                "log warning: o.g.x.i.j.JavaUtilLoggingIT$ShouldLogWithParameters - fgh_67_78");
        assertThat(localSpan.childSpans()).isEmpty();

        localSpan = (LocalSpan) i.next();
        assertThat(localSpan.getMessage()).isEqualTo(
                "log severe: o.g.x.i.j.JavaUtilLoggingIT$ShouldLogWithParameters - ghi_78_89");
        assertThat(localSpan.childSpans()).isEmpty();
