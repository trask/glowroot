 ...
 */
package org.glowroot.xyzzy.annotation.api;
...
public class Glowroot {
    ...
    private static GlowrootService getGlowrootService() {
        Class<?> clazz;
        try {
            clazz = Class.forName("org.glowroot.xyzzy.engine.annotation.spi.GlowrootServiceHolder");
        ...
        try {
            ...
            GlowrootServiceSPI impl = (GlowrootServiceSPI) method.invoke(null);
            if (impl == null) {
