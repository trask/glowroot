...
public class TraceEntryWorthyInstrumentation {
    ...
    public static class TraceEntryWorthyAdvice {
        ...
        private static final TimerName timerName = Agent.getTimerName("trace entry worthy");

        @OnBefore
        public static Span onBefore(ThreadContext context) {
            return context.startLocalSpan(MessageSupplier.create("trace entry worthy"), timerName);
        }
