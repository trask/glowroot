...
public class ConfigService {
    ...
    private static AdviceConfig toAdviceConfig(CustomInstrumentationConfig config) {
        ...
        return builder.nestingGroup(config.nestingGroup())
                ...
                .spanMessageTemplate(config.traceEntryMessageTemplate())
                .spanStackThresholdMillis(config.traceEntryStackThresholdMillis())
                .spanCaptureSelfNested(config.traceEntryCaptureSelfNested())
