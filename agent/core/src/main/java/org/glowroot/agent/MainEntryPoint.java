...
public class MainEntryPoint {
    ...
    private static GlowrootAgentInit createGlowrootAgentInit(Directories directories,
        ...
        Constructor<? extends Collector> customCollectorDelegatingConstructor = null;
        if (customCollectorClass != null) {
            try {
                customCollectorDelegatingConstructor =
                        customCollectorClass.getConstructor(Collector.class);
            } catch (NoSuchMethodException e) {
                startupLogger.debug(e.getMessage(), e);
            }
        }
        if (customCollectorClass != null && customCollectorDelegatingConstructor == null) {
