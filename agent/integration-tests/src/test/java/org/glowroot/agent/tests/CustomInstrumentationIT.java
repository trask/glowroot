...
public class CustomInstrumentationIT {
    ...
    protected static CustomInstrumentationConfig buildInstrumentationForExecute1()
            throws Exception {
        return CustomInstrumentationConfig.newBuilder()
                .setClassName("org.glowroot.agent.tests.CustomInstrumentationIT$Misc")
    ...
    protected static CustomInstrumentationConfig buildInstrumentationForExecute1TimerOnly()
            throws Exception {
        return CustomInstrumentationConfig.newBuilder()
                .setClassName("org.glowroot.agent.tests.CustomInstrumentationIT$Misc")
                .setMethodName("execute1")
    ...
    protected static CustomInstrumentationConfig buildInstrumentationForExecuteWithReturn()
            throws Exception {
        return CustomInstrumentationConfig.newBuilder()
                .setClassName("org.glowroot.agent.tests.CustomInstrumentationIT$Misc")
    ...
    protected static CustomInstrumentationConfig buildCustomInstrumentationForExecuteWithArgs()
            throws Exception {
        return CustomInstrumentationConfig.newBuilder()
                .setClassName("org.glowroot.agent.tests.CustomInstrumentationIT$Misc")
                ...
                .addMethodParameterType(
                        "org.glowroot.agent.tests.CustomInstrumentationIT$BasicMisc")
