...
class InstrumentationSeekerClassVisitor extends ClassVisitor {
    ...
    private class InstrumentationAnnotationMethodVisitor extends MethodVisitor {
        ...
        public @Nullable AnnotationVisitor visitAnnotation(String descriptor, boolean visible) {
            if (descriptor.equals("Lorg/glowroot/xyzzy/annotation/api/Instrumentation$Transaction;")
                    || descriptor
                            .equals("Lorg/glowroot/xyzzy/instrumentation/api/Instrument$Transaction;")) {
                transactionAnnotationVisitor = new TransactionAnnotationVisitor();
                return transactionAnnotationVisitor;
            } else if (descriptor
                    .equals("Lorg/glowroot/xyzzy/annotation/api/Instrumentation$TraceEntry;")
                    || descriptor
                            .equals("Lorg/glowroot/xyzzy/instrumentation/api/Instrument$TraceEntry;")) {
                traceEntryAnnotationVisitor = new TraceEntryAnnotationVisitor();
                return traceEntryAnnotationVisitor;
            } else if (descriptor
                    .equals("Lorg/glowroot/xyzzy/annotation/api/Instrumentation$Timer;")
                    || descriptor
                            .equals("Lorg/glowroot/xyzzy/instrumentation/api/Instrument$Timer;")) {
