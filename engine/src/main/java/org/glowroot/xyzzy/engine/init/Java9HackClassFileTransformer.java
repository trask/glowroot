...
class Java9HackClassFileTransformer implements ClassFileTransformer {
    ...
    public byte /*@Nullable*/ [] transform(@Nullable ClassLoader loader, @Nullable String className,
            ...
            byte[] bytes) {
        try {
            if ("org/glowroot/xyzzy/engine/weaving/WeavingClassFileTransformer".equals(className)) {
        ...
        public MethodVisitor visitMethod(int access, String name, String descriptor,
            ...
            if (name.equals("transform") && descriptor.equals("(Ljava/lang/ClassLoader;"
                ...
                mv.visitMethodInsn(INVOKEVIRTUAL,
                        "org/glowroot/xyzzy/engine/weaving/WeavingClassFileTransformer", "transformJava9",
