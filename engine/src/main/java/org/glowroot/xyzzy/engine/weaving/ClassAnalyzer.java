...
import org.glowroot.xyzzy.engine.weaving.ThinClassVisitor.ThinMethod;
...
class ClassAnalyzer {
    ...
    ClassAnalyzer(ThinClass thinClass, List<Advice> advisors, List<ShimType> shimTypes,
        ...
        ParseContext parseContext = ImmutableParseContext.builder()
                .className(className)
    ...
    private static List<AnalyzedClass> hack(ThinClass thinClass, ClassLoader loader,
        ...
        ImmutableMap<Advice, LazyDefinedClass> newAdvisors =
                AdviceGenerator.createAdvisors(configs, null, false, false);
        try {
