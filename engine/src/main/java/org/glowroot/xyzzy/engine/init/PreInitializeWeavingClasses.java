...
public class PreInitializeWeavingClasses {
    ...
    public static void preInitializeClasses() {
        ...
        // see FileInstrumentationPresentAtStartupIT
        new TimerNameCache().getTimerName(OnlyForTheTimerName.class);
    }
    ...
    private static List<String> getGlowrootUsedTypes() {
        List<String> types = Lists.newArrayList();
        types.add("org.glowroot.xyzzy.engine.bytecode.api.Bytecode");
        types.add("org.glowroot.xyzzy.engine.bytecode.api.BytecodeService");
        types.add("org.glowroot.xyzzy.engine.bytecode.api.BytecodeServiceHolder");
        types.add("org.glowroot.xyzzy.engine.bytecode.api.ThreadContextPlus");
        types.add("org.glowroot.xyzzy.engine.bytecode.api.ThreadContextThreadLocal$Holder");
        types.add("org.glowroot.xyzzy.engine.bytecode.api.Util");
        types.add("org.glowroot.xyzzy.engine.config.ImmutableAdviceConfig");
        types.add("org.glowroot.xyzzy.engine.config.ImmutableAdviceConfig$Builder");
        types.add("org.glowroot.xyzzy.engine.config.ImmutableAdviceConfig$InitShim");
        types.add("org.glowroot.xyzzy.engine.config.AdviceConfig");
        types.add("org.glowroot.xyzzy.engine.config.AdviceConfig$CaptureKind");
        types.add("org.glowroot.xyzzy.engine.config.AdviceConfig$AlreadyInTransactionBehavior");
        types.add("org.glowroot.xyzzy.engine.util.IterableWithSelfRemovableEntries");
        types.add("org.glowroot.xyzzy.engine.util.IterableWithSelfRemovableEntries$ElementIterator");
        types.add("org.glowroot.xyzzy.engine.util.IterableWithSelfRemovableEntries$Entry");
        types.add("org.glowroot.xyzzy.engine.util.IterableWithSelfRemovableEntries$SelfRemovableEntry");
        types.add("org.glowroot.xyzzy.engine.weaving.Advice");
        types.add("org.glowroot.xyzzy.engine.weaving.AdviceGenerator");
        types.add("org.glowroot.xyzzy.engine.weaving.Advice$AdviceOrdering");
        types.add("org.glowroot.xyzzy.engine.weaving.Advice$AdviceParameter");
        types.add("org.glowroot.xyzzy.engine.weaving.Advice$ParameterKind");
        types.add("org.glowroot.xyzzy.engine.weaving.AdviceAdapter");
        types.add("org.glowroot.xyzzy.engine.weaving.AdviceBuilder");
        types.add("org.glowroot.xyzzy.engine.weaving.AdviceBuilder$AdviceConstructionException");
        types.add("org.glowroot.xyzzy.engine.weaving.AdviceMatcher");
        types.add("org.glowroot.xyzzy.engine.weaving.AnalyzedClass");
        types.add("org.glowroot.xyzzy.engine.weaving.AnalyzedMethod");
        types.add("org.glowroot.xyzzy.engine.weaving.AnalyzedWorld");
        types.add("org.glowroot.xyzzy.engine.weaving.AnalyzedWorld$AnalyzedClassAndLoader");
        types.add("org.glowroot.xyzzy.engine.weaving.AnalyzedWorld$ParseContext");
        types.add("org.glowroot.xyzzy.engine.weaving.BootstrapMetaHolders");
        types.add("org.glowroot.xyzzy.engine.weaving.BootstrapMetaHolders$ClassMetaHolder");
        types.add("org.glowroot.xyzzy.engine.weaving.BootstrapMetaHolders$MethodMetaHolder");
        types.add("org.glowroot.xyzzy.engine.weaving.ClassAnalyzer");
        types.add("org.glowroot.xyzzy.engine.weaving.ClassAnalyzer$AnalyzedMethodKey");
        types.add("org.glowroot.xyzzy.engine.weaving.ClassAnalyzer$BridgeMethodClassVisitor");
        types.add("org.glowroot.xyzzy.engine.weaving.ClassAnalyzer$BridgeMethodClassVisitor"
                + "$BridgeMethodVisitor");
        types.add("org.glowroot.xyzzy.engine.weaving.ClassAnalyzer$MatchedMixinTypes");
        types.add("org.glowroot.xyzzy.engine.weaving.ClassAnalyzer$NonAbstractMethodClassVisitor");
        types.add("org.glowroot.xyzzy.engine.weaving.ClassInfoImpl");
        types.add("org.glowroot.xyzzy.engine.weaving.ClassLoaders");
        types.add("org.glowroot.xyzzy.engine.weaving.ClassLoaders$LazyDefinedClass");
        types.add("org.glowroot.xyzzy.engine.weaving.ClassNames");
        types.add("org.glowroot.xyzzy.engine.weaving.FrameDeduppingMethodVisitor");
        types.add("org.glowroot.xyzzy.engine.weaving.MethodInfoImpl");
        types.add("org.glowroot.xyzzy.engine.weaving.Weaver$ActiveWeaving");
        types.add("org.glowroot.xyzzy.engine.weaving.Weaver$ClassLoaderHackClassVisitor");
        types.add("org.glowroot.xyzzy.engine.weaving.Weaver$ClassLoaderHackMethodVisitor");
        types.add("org.glowroot.xyzzy.engine.weaving.Weaver$JBossUrlHackClassVisitor");
        types.add("org.glowroot.xyzzy.engine.weaving.Weaver$JBossUrlHackMethodVisitor");
        types.add("org.glowroot.xyzzy.engine.weaving.ImmutableAdvice");
        types.add("org.glowroot.xyzzy.engine.weaving.ImmutableAdvice$Builder");
        types.add("org.glowroot.xyzzy.engine.weaving.ImmutableAdvice$InitShim");
        types.add("org.glowroot.xyzzy.engine.weaving.ImmutableAnalyzedClassAndLoader");
        types.add("org.glowroot.xyzzy.engine.weaving.ImmutableAnalyzedClassAndLoader$Builder");
        types.add("org.glowroot.xyzzy.engine.weaving.ImmutablePointcutClass");
        types.add("org.glowroot.xyzzy.engine.weaving.ImmutablePointcutClass$Builder");
        types.add("org.glowroot.xyzzy.engine.weaving.ImmutablePointcutMethod");
        types.add("org.glowroot.xyzzy.engine.weaving.ImmutablePointcutMethod$Builder");
        types.add("org.glowroot.xyzzy.engine.weaving.ImmutableAdviceMatcher");
        types.add("org.glowroot.xyzzy.engine.weaving.ImmutableAdviceMatcher$Builder");
        types.add("org.glowroot.xyzzy.engine.weaving.ImmutableAdviceParameter");
        types.add("org.glowroot.xyzzy.engine.weaving.ImmutableAdviceParameter$Builder");
        types.add("org.glowroot.xyzzy.engine.weaving.ImmutableAnalyzedClass");
        types.add("org.glowroot.xyzzy.engine.weaving.ImmutableAnalyzedClass$Builder");
        types.add("org.glowroot.xyzzy.engine.weaving.ImmutableAnalyzedMethod");
        types.add("org.glowroot.xyzzy.engine.weaving.ImmutableAnalyzedMethod$Builder");
        types.add("org.glowroot.xyzzy.engine.weaving.ImmutableAnalyzedMethodKey");
        types.add("org.glowroot.xyzzy.engine.weaving.ImmutableAnalyzedMethodKey$Builder");
        types.add("org.glowroot.xyzzy.engine.weaving.ImmutableCatchHandler");
        types.add("org.glowroot.xyzzy.engine.weaving.ImmutableCatchHandler$Builder");
        types.add("org.glowroot.xyzzy.engine.weaving.ImmutableLazyDefinedClass");
        types.add("org.glowroot.xyzzy.engine.weaving.ImmutableLazyDefinedClass$Builder");
        types.add("org.glowroot.xyzzy.engine.weaving.ImmutableMatchedMixinTypes");
        types.add("org.glowroot.xyzzy.engine.weaving.ImmutableMatchedMixinTypes$Builder");
        types.add("org.glowroot.xyzzy.engine.weaving.ImmutableMethodMetaGroup");
        types.add("org.glowroot.xyzzy.engine.weaving.ImmutableMethodMetaGroup$Builder");
        types.add("org.glowroot.xyzzy.engine.weaving.ImmutableParseContext");
        types.add("org.glowroot.xyzzy.engine.weaving.ImmutableParseContext$Builder");
        types.add("org.glowroot.xyzzy.engine.weaving.ImmutablePublicFinalMethod");
        types.add("org.glowroot.xyzzy.engine.weaving.ImmutablePublicFinalMethod$Builder");
        types.add("org.glowroot.xyzzy.engine.weaving.ImmutableThinClass");
        types.add("org.glowroot.xyzzy.engine.weaving.ImmutableThinClass$Builder");
        types.add("org.glowroot.xyzzy.engine.weaving.ImmutableThinMethod");
        types.add("org.glowroot.xyzzy.engine.weaving.ImmutableThinMethod$Builder");
        types.add("org.glowroot.xyzzy.engine.weaving.InstrumentationSeekerClassVisitor");
        types.add("org.glowroot.xyzzy.engine.weaving.InstrumentationSeekerClassVisitor"
        ...
        types.add("org.glowroot.xyzzy.engine.weaving.JSRInlinerClassVisitor");
        types.add("org.glowroot.xyzzy.engine.weaving.MaybePatterns");
        types.add("org.glowroot.xyzzy.engine.weaving.MixinType");
        types.add("org.glowroot.xyzzy.engine.weaving.InstrumentationClassRenamer");
        types.add("org.glowroot.xyzzy.engine.weaving.InstrumentationClassRenamer"
                + "$InstrumentationClassRemapper");
        types.add("org.glowroot.xyzzy.engine.weaving.InstrumentationDetail$PointcutClass");
        types.add("org.glowroot.xyzzy.engine.weaving.InstrumentationDetail$PointcutMethod");
        types.add("org.glowroot.xyzzy.engine.weaving.InstrumentationDetailBuilder");
        types.add("org.glowroot.xyzzy.engine.weaving.InstrumentationDetailBuilder$MemberClassVisitor");
        types.add("org.glowroot.xyzzy.engine.weaving.InstrumentationDetailBuilder$MixinMethodVisitor");
        types.add("org.glowroot.xyzzy.engine.weaving.InstrumentationDetailBuilder$PointcutMethodVisitor");
        types.add("org.glowroot.xyzzy.engine.weaving.InstrumentationDetailBuilder"
        ...
        types.add("org.glowroot.xyzzy.engine.weaving.PointcutClassVisitor");
        types.add("org.glowroot.xyzzy.engine.weaving.PointcutClassVisitor$PointcutAnnotationVisitor");
        types.add("org.glowroot.xyzzy.engine.weaving.PointcutClassVisitor$PointcutMethodVisitor");
        types.add("org.glowroot.xyzzy.engine.weaving.PreloadSomeSuperTypesCache");
        types.add("org.glowroot.xyzzy.engine.weaving.PreloadSomeSuperTypesCache$CacheValue");
        types.add("org.glowroot.xyzzy.engine.weaving.PublicFinalMethod");
        types.add("org.glowroot.xyzzy.engine.weaving.ShimType");
        types.add("org.glowroot.xyzzy.engine.weaving.ThinClassVisitor");
        types.add("org.glowroot.xyzzy.engine.weaving.ThinClassVisitor$AnnotationCaptureMethodVisitor");
        types.add("org.glowroot.xyzzy.engine.weaving.ThinClassVisitor$PointcutAnnotationVisitor");
        types.add("org.glowroot.xyzzy.engine.weaving.ThinClassVisitor$RemoteAnnotationVisitor");
        types.add("org.glowroot.xyzzy.engine.weaving.ThinClassVisitor$ValueAnnotationVisitor");
        types.add("org.glowroot.xyzzy.engine.weaving.ThinClassVisitor$ThinClass");
        types.add("org.glowroot.xyzzy.engine.weaving.ThinClassVisitor$ThinMethod");
        types.add("org.glowroot.xyzzy.engine.weaving.Weaver");
        types.add("org.glowroot.xyzzy.engine.weaving.WeavingClassFileTransformer");
        types.add("org.glowroot.xyzzy.engine.weaving.WeavingClassVisitor");
        types.add("org.glowroot.xyzzy.engine.weaving.WeavingClassVisitor$InitMixins");
        types.add("org.glowroot.xyzzy.engine.weaving.WeavingClassVisitor$MethodMetaGroup");
        types.add("org.glowroot.xyzzy.engine.weaving.WeavingMethodVisitor");
        types.add("org.glowroot.xyzzy.engine.weaving.WeavingMethodVisitor$CatchHandler");
        types.add("org.glowroot.xyzzy.instrumentation.api.ClassInfo");
        types.add("org.glowroot.xyzzy.instrumentation.api.MethodInfo");
        types.add("org.glowroot.xyzzy.instrumentation.api.OptionalThreadContext");
        types.add("org.glowroot.xyzzy.instrumentation.api.ParameterHolder");
        types.add("org.glowroot.xyzzy.instrumentation.api.ThreadContext");
        types.add("org.glowroot.xyzzy.instrumentation.api.internal.ParameterHolderImpl");
        types.add("org.glowroot.xyzzy.instrumentation.api.weaving.BindClassMeta");
        types.add("org.glowroot.xyzzy.instrumentation.api.weaving.BindMethodMeta");
        types.add("org.glowroot.xyzzy.instrumentation.api.weaving.BindMethodName");
        types.add("org.glowroot.xyzzy.instrumentation.api.weaving.BindOptionalReturn");
        types.add("org.glowroot.xyzzy.instrumentation.api.weaving.BindParameter");
        types.add("org.glowroot.xyzzy.instrumentation.api.weaving.BindParameterArray");
        types.add("org.glowroot.xyzzy.instrumentation.api.weaving.BindReceiver");
        types.add("org.glowroot.xyzzy.instrumentation.api.weaving.BindReturn");
        types.add("org.glowroot.xyzzy.instrumentation.api.weaving.BindThrowable");
        types.add("org.glowroot.xyzzy.instrumentation.api.weaving.BindTraveler");
        types.add("org.glowroot.xyzzy.instrumentation.api.weaving.IsEnabled");
        types.add("org.glowroot.xyzzy.instrumentation.api.weaving.MethodModifier");
        types.add("org.glowroot.xyzzy.instrumentation.api.weaving.OnAfter");
        types.add("org.glowroot.xyzzy.instrumentation.api.weaving.OnBefore");
        types.add("org.glowroot.xyzzy.instrumentation.api.weaving.OnReturn");
        types.add("org.glowroot.xyzzy.instrumentation.api.weaving.OnThrow");
        types.add("org.glowroot.xyzzy.instrumentation.api.weaving.Pointcut");
        types.add("org.glowroot.xyzzy.instrumentation.api.weaving.Shim");
        return types;
    }
    ...
    public static List<String> maybeUsedTypes() {
        ...
        types.add("org.glowroot.xyzzy.engine.config.ImmutableAdviceConfig$1");
        types.add("org.glowroot.xyzzy.engine.util.IterableWithSelfRemovableEntries$1");
        types.add("org.glowroot.xyzzy.engine.weaving.Advice$1");
        types.add("org.glowroot.xyzzy.engine.weaving.AdviceBuilder$1");
        types.add("org.glowroot.xyzzy.engine.weaving.AnalyzedClass$1");
        types.add("org.glowroot.xyzzy.engine.weaving.AnalyzedMethod$1");
        types.add("org.glowroot.xyzzy.engine.weaving.AnalyzedMethodKey$1");
        types.add("org.glowroot.xyzzy.engine.weaving.BootstrapMetaHolders$1");
        types.add("org.glowroot.xyzzy.engine.weaving.ClassAnalyzer$1");
        types.add("org.glowroot.xyzzy.engine.weaving.ClassAnalyzer$BridgeMethodClassVisitor$1");
        types.add("org.glowroot.xyzzy.engine.weaving.ImmutablePointcutClass$1");
        types.add("org.glowroot.xyzzy.engine.weaving.ImmutablePointcutMethod$1");
        types.add("org.glowroot.xyzzy.engine.weaving.ImmutableAnalyzedClass$1");
        types.add("org.glowroot.xyzzy.engine.weaving.ImmutableAnalyzedClassAndLoader$1");
        types.add("org.glowroot.xyzzy.engine.weaving.ImmutableAnalyzedMethod$1");
        types.add("org.glowroot.xyzzy.engine.weaving.ImmutableAnalyzedMethodKey$1");
        types.add("org.glowroot.xyzzy.engine.weaving.ImmutableAdvice$1");
        types.add("org.glowroot.xyzzy.engine.weaving.ImmutableAdviceMatcher$1");
        types.add("org.glowroot.xyzzy.engine.weaving.ImmutableAdviceParameter$1");
        types.add("org.glowroot.xyzzy.engine.weaving.ImmutableCatchHandler$1");
        types.add("org.glowroot.xyzzy.engine.weaving.ImmutableLazyDefinedClass$1");
        types.add("org.glowroot.xyzzy.engine.weaving.ImmutableMatchedMixinTypes$1");
        types.add("org.glowroot.xyzzy.engine.weaving.ImmutableMethodMetaGroup$1");
        types.add("org.glowroot.xyzzy.engine.weaving.ImmutableParseContext$1");
        types.add("org.glowroot.xyzzy.engine.weaving.ImmutablePublicFinalMethod$1");
        types.add("org.glowroot.xyzzy.engine.weaving.ImmutableThinClass$1");
        types.add("org.glowroot.xyzzy.engine.weaving.ImmutableThinMethod$1");
        types.add("org.glowroot.xyzzy.engine.weaving.InstrumentationSeekerClassVisitor$1");
        types.add("org.glowroot.xyzzy.engine.weaving.MethodMetaGroup$1");
        types.add("org.glowroot.xyzzy.engine.weaving.ThinClassVisitor$1");
        types.add("org.glowroot.xyzzy.engine.weaving.InstrumentationClassRenamer$1");
        types.add("org.glowroot.xyzzy.engine.weaving.InstrumentationDetailBuilder$1");
        types.add("org.glowroot.xyzzy.engine.weaving.PointcutClassVisitor$1");
        types.add("org.glowroot.xyzzy.engine.weaving.Weaver$1");
        types.add("org.glowroot.xyzzy.engine.weaving.Weaver$2");
        types.add("org.glowroot.xyzzy.engine.weaving.Weaver$FelixOsgiHackClassVisitor$1");
        types.add("org.glowroot.xyzzy.engine.weaving.Weaver$EclipseOsgiHackClassVisitor$1");
        types.add("org.glowroot.xyzzy.engine.weaving.WeavingClassVisitor$1");
        types.add("org.glowroot.xyzzy.engine.weaving.AdviceMatcher$1");
        types.add("org.glowroot.xyzzy.engine.weaving.WeavingMethodVisitor$1");
        types.add("org.glowroot.xyzzy.engine.weaving.PreloadSomeSuperTypesCache$1");
        types.add("org.glowroot.xyzzy.instrumentation.api.config.ConfigListener");
        return types;
    }
    ...
    private static void preInitializeLinkedHashMapKeySetAndKeySetIterator() {
        ...
        // org.glowroot.xyzzy.engine.weaving.AnalyzedWorld.createAnalyzedClass(AnalyzedWorld.java:320)
        // org.glowroot.xyzzy.engine.weaving.AnalyzedWorld.getOrCreateAnalyzedClass(AnalyzedWorld.java:232)
        // org.glowroot.xyzzy.engine.weaving.AnalyzedWorld.getSuperClasses(AnalyzedWorld.java:189)
        // org.glowroot.xyzzy.engine.weaving.AnalyzedWorld.getAnalyzedHierarchy(AnalyzedWorld.java:139)
        // org.glowroot.xyzzy.engine.weaving.ClassAnalyzer.<init>(ClassAnalyzer.java:108)
        // org.glowroot.xyzzy.engine.weaving.Weaver.weaveUnderTimer(Weaver.java:144)
        // org.glowroot.xyzzy.engine.weaving.Weaver.weave(Weaver.java:95)
        // org.glowroot.xyzzy.engine.weaving.WeavingClassFileTransformer.transformInternal(WeavingClassFileTransformer.java:86)
        // org.glowroot.xyzzy.engine.weaving.WeavingClassFileTransformer.transform(WeavingClassFileTransformer.java:65)
    ...
    @Pointcut(className = "", methodName = "", methodParameterTypes = {}, timerName = "dummy")
