 ...
 */
package org.glowroot.xyzzy.engine.annotation.spi;

import org.checkerframework.checker.nullness.qual.Nullable;

public class GlowrootServiceHolder {

    private static volatile @Nullable GlowrootServiceSPI service;
    private static volatile @Nullable Exception retrievedTooEarlyLocation;

    private GlowrootServiceHolder() {}

    public static @Nullable GlowrootServiceSPI get() {
        if (service == null) {
    ...
    public static void set(GlowrootServiceSPI service) {
