...
public class IsolatedWeavingClassLoader extends ClassLoader {
    ...
    public static boolean loadWithParentClassLoader(String name) {
        ...
        if (name.startsWith("org.glowroot.xyzzy.instrumentation.api.")
                || name.startsWith("org.glowroot.xyzzy.engine.bytecode.api.")
                || name.startsWith("org.glowroot.xyzzy.engine.annotation.spi.")) {
            return true;
        }
        return false;
    }
