...
import org.glowroot.xyzzy.engine.weaving.AdviceBuilder;
import org.glowroot.xyzzy.engine.weaving.AnalyzedWorld;
import org.glowroot.xyzzy.engine.weaving.InstrumentationDetailBuilder;
import org.glowroot.xyzzy.engine.weaving.IsolatedWeavingClassLoader;
import org.glowroot.xyzzy.engine.weaving.MixinType;
import org.glowroot.xyzzy.engine.weaving.ShimType;
import org.glowroot.xyzzy.engine.weaving.Weaver;
import org.glowroot.xyzzy.engine.weaving.ClassLoaders.LazyDefinedClass;
import org.glowroot.xyzzy.engine.weaving.SomeInstrumentation.AnotherAnnotationBasedAdvice;
import org.glowroot.xyzzy.engine.weaving.SomeInstrumentation.AnotherAnnotationBasedAdviceButWrong;
import org.glowroot.xyzzy.engine.weaving.SomeInstrumentation.BasicAdvice;
import org.glowroot.xyzzy.engine.weaving.SomeInstrumentation.BasicAnnotationBasedAdvice;
import org.glowroot.xyzzy.engine.weaving.SomeInstrumentation.BasicHighOrderAdvice;
import org.glowroot.xyzzy.engine.weaving.SomeInstrumentation.BasicMiscAllConstructorAdvice;
import org.glowroot.xyzzy.engine.weaving.SomeInstrumentation.BasicMiscConstructorAdvice;
import org.glowroot.xyzzy.engine.weaving.SomeInstrumentation.BasicWithInnerClassAdvice;
import org.glowroot.xyzzy.engine.weaving.SomeInstrumentation.BasicWithInnerClassArgAdvice;
import org.glowroot.xyzzy.engine.weaving.SomeInstrumentation.BindAutoboxedReturnAdvice;
import org.glowroot.xyzzy.engine.weaving.SomeInstrumentation.BindClassMetaAdvice;
import org.glowroot.xyzzy.engine.weaving.SomeInstrumentation.BindMethodMetaAdvice;
import org.glowroot.xyzzy.engine.weaving.SomeInstrumentation.BindMethodMetaArrayAdvice;
import org.glowroot.xyzzy.engine.weaving.SomeInstrumentation.BindMethodMetaReturnArrayAdvice;
import org.glowroot.xyzzy.engine.weaving.SomeInstrumentation.BindMethodNameAdvice;
import org.glowroot.xyzzy.engine.weaving.SomeInstrumentation.BindMutableParameterAdvice;
import org.glowroot.xyzzy.engine.weaving.SomeInstrumentation.BindMutableParameterWithMoreFramesAdvice;
import org.glowroot.xyzzy.engine.weaving.SomeInstrumentation.BindOptionalPrimitiveReturnAdvice;
import org.glowroot.xyzzy.engine.weaving.SomeInstrumentation.BindOptionalReturnAdvice;
import org.glowroot.xyzzy.engine.weaving.SomeInstrumentation.BindOptionalVoidReturnAdvice;
import org.glowroot.xyzzy.engine.weaving.SomeInstrumentation.BindParameterAdvice;
import org.glowroot.xyzzy.engine.weaving.SomeInstrumentation.BindParameterArrayAdvice;
import org.glowroot.xyzzy.engine.weaving.SomeInstrumentation.BindPrimitiveBooleanTravelerAdvice;
import org.glowroot.xyzzy.engine.weaving.SomeInstrumentation.BindPrimitiveReturnAdvice;
import org.glowroot.xyzzy.engine.weaving.SomeInstrumentation.BindPrimitiveTravelerAdvice;
import org.glowroot.xyzzy.engine.weaving.SomeInstrumentation.BindReceiverAdvice;
import org.glowroot.xyzzy.engine.weaving.SomeInstrumentation.BindReturnAdvice;
import org.glowroot.xyzzy.engine.weaving.SomeInstrumentation.BindThrowableAdvice;
import org.glowroot.xyzzy.engine.weaving.SomeInstrumentation.BindTravelerAdvice;
import org.glowroot.xyzzy.engine.weaving.SomeInstrumentation.BrokenAdvice;
import org.glowroot.xyzzy.engine.weaving.SomeInstrumentation.ChangeReturnAdvice;
import org.glowroot.xyzzy.engine.weaving.SomeInstrumentation.CircularClassDependencyAdvice;
import org.glowroot.xyzzy.engine.weaving.SomeInstrumentation.ClassNamePatternAdvice;
import org.glowroot.xyzzy.engine.weaving.SomeInstrumentation.ComplexSuperTypeRestrictionAdvice;
import org.glowroot.xyzzy.engine.weaving.SomeInstrumentation.FinalMethodAdvice;
import org.glowroot.xyzzy.engine.weaving.SomeInstrumentation.GenericMiscAdvice;
import org.glowroot.xyzzy.engine.weaving.SomeInstrumentation.HackedConstructorBytecodeAdvice;
import org.glowroot.xyzzy.engine.weaving.SomeInstrumentation.HackedConstructorBytecodeJumpingAdvice;
import org.glowroot.xyzzy.engine.weaving.SomeInstrumentation.HasString;
import org.glowroot.xyzzy.engine.weaving.SomeInstrumentation.HasStringClassMixin;
import org.glowroot.xyzzy.engine.weaving.SomeInstrumentation.HasStringInterfaceMixin;
import org.glowroot.xyzzy.engine.weaving.SomeInstrumentation.HasStringMultipleMixin;
import org.glowroot.xyzzy.engine.weaving.SomeInstrumentation.InterfaceAppearsTwiceInHierarchyAdvice;
import org.glowroot.xyzzy.engine.weaving.SomeInstrumentation.MatchingPublicNonStaticAdvice;
import org.glowroot.xyzzy.engine.weaving.SomeInstrumentation.MethodParametersBadDotDotAdvice1;
import org.glowroot.xyzzy.engine.weaving.SomeInstrumentation.MethodParametersDotDotAdvice1;
import org.glowroot.xyzzy.engine.weaving.SomeInstrumentation.MethodParametersDotDotAdvice2;
import org.glowroot.xyzzy.engine.weaving.SomeInstrumentation.MethodParametersDotDotAdvice3;
import org.glowroot.xyzzy.engine.weaving.SomeInstrumentation.MethodReturnCharSequenceAdvice;
import org.glowroot.xyzzy.engine.weaving.SomeInstrumentation.MethodReturnStringAdvice;
import org.glowroot.xyzzy.engine.weaving.SomeInstrumentation.MethodReturnVoidAdvice;
import org.glowroot.xyzzy.engine.weaving.SomeInstrumentation.MoreNotPerfectBytecodeAdvice;
import org.glowroot.xyzzy.engine.weaving.SomeInstrumentation.MultipleMethodsAdvice;
import org.glowroot.xyzzy.engine.weaving.SomeInstrumentation.NonMatchingMethodReturnAdvice;
import org.glowroot.xyzzy.engine.weaving.SomeInstrumentation.NonMatchingMethodReturnAdvice2;
import org.glowroot.xyzzy.engine.weaving.SomeInstrumentation.NonMatchingStaticAdvice;
import org.glowroot.xyzzy.engine.weaving.SomeInstrumentation.NotPerfectBytecodeAdvice;
import org.glowroot.xyzzy.engine.weaving.SomeInstrumentation.PrimitiveAdvice;
import org.glowroot.xyzzy.engine.weaving.SomeInstrumentation.PrimitiveWithAutoboxAdvice;
import org.glowroot.xyzzy.engine.weaving.SomeInstrumentation.PrimitiveWithWildcardAdvice;
import org.glowroot.xyzzy.engine.weaving.SomeInstrumentation.Shimmy;
import org.glowroot.xyzzy.engine.weaving.SomeInstrumentation.StaticAdvice;
import org.glowroot.xyzzy.engine.weaving.SomeInstrumentation.SubTypeRestrictionAdvice;
import org.glowroot.xyzzy.engine.weaving.SomeInstrumentation.SubTypeRestrictionWhereMethodNotReImplementedInSubClassAdvice;
import org.glowroot.xyzzy.engine.weaving.SomeInstrumentation.SubTypeRestrictionWhereMethodNotReImplementedInSubSubClassAdvice;
import org.glowroot.xyzzy.engine.weaving.SomeInstrumentation.SuperBasicAdvice;
import org.glowroot.xyzzy.engine.weaving.SomeInstrumentation.SuperTypeRestrictionAdvice;
import org.glowroot.xyzzy.engine.weaving.SomeInstrumentation.SuperTypeRestrictionWhereMethodNotReImplementedInSubClassAdvice;
import org.glowroot.xyzzy.engine.weaving.SomeInstrumentation.TestBytecodeWithStackFramesAdvice;
import org.glowroot.xyzzy.engine.weaving.SomeInstrumentation.TestBytecodeWithStackFramesAdvice2;
import org.glowroot.xyzzy.engine.weaving.SomeInstrumentation.TestBytecodeWithStackFramesAdvice3;
import org.glowroot.xyzzy.engine.weaving.SomeInstrumentation.TestBytecodeWithStackFramesAdvice4;
import org.glowroot.xyzzy.engine.weaving.SomeInstrumentation.TestBytecodeWithStackFramesAdvice5;
import org.glowroot.xyzzy.engine.weaving.SomeInstrumentation.TestBytecodeWithStackFramesAdvice6;
import org.glowroot.xyzzy.engine.weaving.SomeInstrumentation.TestClassMeta;
import org.glowroot.xyzzy.engine.weaving.SomeInstrumentation.TestMethodMeta;
import org.glowroot.xyzzy.engine.weaving.SomeInstrumentation.TestTroublesomeBytecodeAdvice;
import org.glowroot.xyzzy.engine.weaving.SomeInstrumentation.ThrowInOnBeforeAdvice;
import org.glowroot.xyzzy.engine.weaving.SomeInstrumentation.ThrowableToStringAdvice;
import org.glowroot.xyzzy.engine.weaving.SomeInstrumentation.WildMethodAdvice;
import org.glowroot.xyzzy.engine.weaving.SomeInstrumentationThreadLocals.IntegerThreadLocal;
import org.glowroot.xyzzy.engine.weaving.other.ArrayMisc;
import org.glowroot.xyzzy.engine.weaving.targets.AccessibilityMisc;
import org.glowroot.xyzzy.engine.weaving.targets.BasicMisc;
import org.glowroot.xyzzy.engine.weaving.targets.BytecodeWithStackFramesMisc;
import org.glowroot.xyzzy.engine.weaving.targets.DuplicateStackFramesMisc;
import org.glowroot.xyzzy.engine.weaving.targets.ExtendsPackagePrivateMisc;
import org.glowroot.xyzzy.engine.weaving.targets.GenericAbstractMiscImpl;
import org.glowroot.xyzzy.engine.weaving.targets.GenericMisc;
import org.glowroot.xyzzy.engine.weaving.targets.GenericMiscImpl;
import org.glowroot.xyzzy.engine.weaving.targets.InnerTryCatchMisc;
import org.glowroot.xyzzy.engine.weaving.targets.Misc;
import org.glowroot.xyzzy.engine.weaving.targets.Misc2;
import org.glowroot.xyzzy.engine.weaving.targets.NativeMisc;
import org.glowroot.xyzzy.engine.weaving.targets.NestingMisc;
import org.glowroot.xyzzy.engine.weaving.targets.OnlyThrowingMisc;
import org.glowroot.xyzzy.engine.weaving.targets.PrimitiveMisc;
import org.glowroot.xyzzy.engine.weaving.targets.ShimmedMisc;
import org.glowroot.xyzzy.engine.weaving.targets.StaticMisc;
import org.glowroot.xyzzy.engine.weaving.targets.StaticSubbedMisc;
import org.glowroot.xyzzy.engine.weaving.targets.SubBasicMisc;
import org.glowroot.xyzzy.engine.weaving.targets.SubException;
import org.glowroot.xyzzy.engine.weaving.targets.SubMisc;
import org.glowroot.xyzzy.engine.weaving.targets.SuperBasic;
import org.glowroot.xyzzy.engine.weaving.targets.SuperBasicMisc;
import org.glowroot.xyzzy.engine.weaving.targets.ThrowMutatedParamMisc;
import org.glowroot.xyzzy.engine.weaving.targets.ThrowingMisc;
import org.glowroot.xyzzy.engine.weaving.targets.AbstractMisc.ExtendsAbstractMisc;
import org.glowroot.xyzzy.engine.weaving.targets.AbstractNotMisc.ExtendsAbstractNotMisc;
import org.glowroot.xyzzy.engine.weaving.targets.AbstractNotMiscWithFinal.ExtendsAbstractNotMiscWithFinal;
...
public class WeaverTest {
    ...
    public void shouldBindMethodMetaArrays() throws Exception {
        ...
        Class<?> somethingPrivateClass =
                Class.forName("org.glowroot.xyzzy.engine.weaving.other.ArrayMisc$SomethingPrivate");
