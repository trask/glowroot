...
public class PreInitializeWeavingClassesTest {
    ...
    public void shouldCheckHardcodedListAgainstReality() throws IOException {
        ...
        globalCollector.processMethodFailIfNotFound(
                ReferencedMethod.create("org/glowroot/xyzzy/engine/weaving/AnalyzedWorld", "<init>",
                        "(Lcom/google/common/base/Supplier;Ljava/util/List;Ljava/util/List;"
                                + "Lorg/glowroot/xyzzy/engine/weaving/PreloadSomeSuperTypesCache;)V"));
        // "call" WeavingClassFileTransformer constructor
        globalCollector.processMethodFailIfNotFound(
                ReferencedMethod.create("org/glowroot/xyzzy/engine/weaving/WeavingClassFileTransformer",
                        "<init>", "(Lorg/glowroot/xyzzy/engine/weaving/Weaver;"
