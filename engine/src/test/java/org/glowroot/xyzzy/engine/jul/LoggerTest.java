 ...
 */
package org.glowroot.xyzzy.engine.jul;
    ...
    public void testImplementsAllMethods() {
        ...
        for (Method method : Logger.class.getMethods()) {
            ...
            for (Class<?> clazz : method.getParameterTypes()) {
                ...
                builder.addParameterTypes(parameterType.replaceFirst("org.glowroot.xyzzy.engine.jul.",
                        "java.util.logging."));
            }
            glowrootLoggerMethods.add(builder
                    .returnType(method.getReturnType().getName()
                            .replaceFirst("org.glowroot.xyzzy.engine.jul.", "java.util.logging."))
                    .build());
        }
