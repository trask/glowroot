...
public class RoleConfigPage extends Page {
    ...
    public void clickConfigEditCustomInstrumentationCheckBox() {
        clickPermission("config.edit.customInstrumentation");
    }

    public boolean getConfigEditCustomInstrumentationCheckBoxValue() {
        return getPermission("config.edit.customInstrumentation");
    }
