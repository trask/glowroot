...
glowroot.config([
  ...
  function ($provide, $stateProvider, $urlRouterProvider) {
    ...
    $stateProvider.state('config.instrumentation', {
      url: '/instrumentation?id',
      templateUrl: 'views/config/instrumentation.html',
      controller: 'ConfigInstrumentationCtrl'
    });
    $stateProvider.state('config.customInstrumentationList', {
      url: '/custom-instrumentation-list',
      templateUrl: 'views/config/custom-instrumentation-list.html',
      controller: 'ConfigCustomInstrumentationListCtrl'
    });
    $stateProvider.state('config.customInstrumentation', {
      url: '/custom-instrumentation?v',
      templateUrl: 'views/config/custom-instrumentation.html',
      controller: 'ConfigCustomInstrumentationCtrl'
    });
