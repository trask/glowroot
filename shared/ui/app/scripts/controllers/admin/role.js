...
glowroot.controller('AdminRoleCtrl', [
  ...
  function ($scope, $location, $http, $timeout, confirmIfHasChanges, httpErrors) {
    ...
    function populatePermissionBlock(permissionBlock, permission) {
      ...
      } else if (permission === 'agent:config:edit:customInstrumentation') {
        permissionBlock.config.edit.customInstrumentation = true;
    ...
    function cascadeInsidePermissionsObj(permissionsObj) {
      ...
      if (permissionsObj.config._ || permissionsObj.config.edit._) {
        ...
        permissionsObj.config.edit.customInstrumentation = false;
    ...
    $scope.viewConfigRequired = function (permissionsObj) {
      ...
      return permissionsObj.config.edit._ || ($scope.layout.central && permissionsObj.config.edit.general)
          ...
          || permissionsObj.config.edit.instrumentation || permissionsObj.config.edit.customInstrumentation
    ...
    function permissionsObjToList(permissionsObj) {
      ...
      if (permissionsObj.config.edit.customInstrumentation) {
        permissions.push('agent:config:edit:customInstrumentation');
      }
