...
public interface ConfigRepository {
    ...
    @Nullable
    InstrumentationConfig getInstrumentationConfig(String agentId, String instrumentationId)
            throws Exception;

    List<CustomInstrumentationConfig> getCustomInstrumentationConfig(String agentId)
            throws Exception;

    @Nullable
    CustomInstrumentationConfig getCustomInstrumentationConfig(String agentId, String version)
            throws Exception;
    ...
    // only instrumentation id and property names and values are used
    void updateInstrumentationConfig(String agentId, InstrumentationConfig config,
            String priorVersion) throws Exception;

    void insertCustomInstrumentationConfig(String agentId, CustomInstrumentationConfig config)
            throws Exception;

    void updateCustomInstrumentationConfig(String agentId, CustomInstrumentationConfig config,
            String priorVersion) throws Exception;

    void deleteCustomInstrumentationConfigs(String agentId, List<String> versions) throws Exception;

    void insertCustomInstrumentationConfigs(String agentId,
